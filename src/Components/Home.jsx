  ...
  return (
      <div name = "Home" className='h-screen w-full bg-gradient-to-b from-black via-black bg-gray-800 '>
          <div className='max-w-screen-lg mx-auto  flex flex-col items-center justify-center h-full px-4 md:flex-row'>
              <div className='flex flex-col justify-center w-screen h-full  mt-12'>
                  ...
                  <div>
                      <button className='group text-white text-lg font-bold w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from bg-cyan-500 to-blue-500 cursor-pointer' >
